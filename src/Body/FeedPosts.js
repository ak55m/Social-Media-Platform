...
class FeedPosts extends Component {
    render() {
        return (
            ...
            <div>
                <div className="card mb-2 shadow bg-body rounded">
                    <div className="card-header">
                        <div className="d-flex justify-content-between align-items-left">
                            <div className="d-flex justify-content-between align-items-left">
                                ...
                                <div className="ml-2">
                                    <div className="h5 m-0 d-flex">@LeeCross</div>
                                    <div className="h7 mr-5 text-muted">Miracles Lee Cross</div>
                                </div>
                            </div>
                            <div>
                ...
                <div className="card-body">
                    <div className="text-muted h7 text-left" style={{ fontSize: 15, textAlign: 'left' }}> <i className="fa fa-clock-o"></i>10 min ago</div>
                        <a className="card-link" href="#">
                            <h5 className="card-title" style={{ fontSize: 15, textAlign: 'left' }}>Lorem ipsum dolor sit amet, consectetur adip.</h5>
                        </a>

                        <p className="card-text" style={{ fontSize: 15, textAlign: 'left' }}>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo recusandae nulla rem eos ipsa praesentium esse magnam nemo dolo sequi fuga quia quaerat cum, obcaecati hic, molestias minima iste voluptates.
                        </p>
                    </div>
                    <div className="card-footer">
                        <a href="#" className="card-link link-danger"><i className="far fa-heart"></i> Like 1</a>
                        <a href="#" className="card-link link-success"><i className="far fa-comment"></i> Comment 30</a>
                        <a href="#" className="card-link link-secondary"><i className="far fa-share-square"></i> Share 2</a>
                    </div>
                </div>
