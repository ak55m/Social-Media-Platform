...
<div>
    <div class="card mb-2 shadow bg-body rounded">
        ...
        <div class="card-footer">
            <a href="#" class="card-link link-danger"><i class="far fa-heart"></i> Like 1</a>
            <a href="#" class="card-link link-success"><i class="far fa-comment"></i> Comment 30</a>
            <a href="#" class="card-link link-secondary"><i class="far fa-share-square"></i> Share 2</a>
        </div>
    </div>
